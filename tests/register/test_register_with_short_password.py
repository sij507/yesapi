...
class TestRegisterShortPassword:
    ...
    def test_register_with_short_password(self):
        with allure.step('Set up new user register params'):
            ...
            register_params = Params.setup_register_params(new_username, constants.SHORT_MD5_PASSWORD, constants.APP_KEY)

        with allure.step("Send a register request"):
            register_with_short_password = SendRequest(constants.GET, constants.BASE_URL, register_params)
