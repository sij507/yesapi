...
class TestRegisterShortAppKey:
    ...
    def test_register_with_short_app_key(self):
        ...
        with allure.step('Checking msg'):
            allure.attach("Msg " + constants.ERR_MSG_REGISTER_SHORT_APP_KEY, "Expected:")
            allure.attach("Msg: " + register_with_short_app_key.get_msg(), "Actual:")
            assert register_with_short_app_key.get_msg() == constants.ERR_MSG_REGISTER_SHORT_APP_KEY