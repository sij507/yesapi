...
class TestRegisterWithoutUsername:
    ...
    def test_register_without_username(self):
        ...
        with allure.step('Checking msg'):
            allure.attach("Msg " + constants.ERR_MSG_REGISTER_WITHOUT_USERNAME, "Expected:")
            allure.attach("Msg: " + register_without_username.get_msg(), "Actual:")
            assert register_without_username.get_msg() == constants.ERR_MSG_REGISTER_WITHOUT_USERNAME