...
class TestRegisterWithoutAppKey:
    ...
    def test_register_without_app_key(self):
        ...
        with allure.step('Checking msg'):
            allure.attach("Msg " + constants.ERR_MSG_REGISTER_WITHOUT_APP_KEY, "Expected:")
            allure.attach("Msg: " + register_without_app_key.get_msg(), "Actual:")
            assert register_without_app_key.get_msg() == constants.ERR_MSG_REGISTER_WITHOUT_APP_KEY