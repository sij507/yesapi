...
class TestRegisterLongUsername:
    ...
    def test_register_with_long_username(self):
        ...
        with allure.step('Checking msg'):
            allure.attach("Msg " + constants.ERR_MSG_REGISTER_LONG_USERNAME, "Expected:")
            allure.attach("Msg: " + register_with_long_username.get_msg(), "Actual:")
            assert register_with_long_username.get_msg() == constants.ERR_MSG_REGISTER_LONG_USERNAME
