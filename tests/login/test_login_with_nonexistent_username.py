...
class TestLoginWithNonexistentUsername:
    ...
    def test_login_with_invalid_username(self):
        ...
        with allure.step('Checking Err_msg'):
            allure.attach("Err_msg " + constants.ERR_MSG_LOGIN_NONEXISTENT_USERNAME, "Expected:")
            allure.attach("Err_msg: " + login_with_nonexistent_username.get_err_msg(), "Actual:")
            assert login_with_nonexistent_username.get_err_msg() == constants.ERR_MSG_LOGIN_NONEXISTENT_USERNAME
