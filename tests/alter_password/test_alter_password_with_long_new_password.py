...
class TestAlterPasswordWithLongNewPassword:
    ...
    def test_alter_password_with_long_new_password(self):
        ...
        with allure.step("Checking msg"):
            allure.attach("Msg contains: " + constants.ERR_MSG_NEW_PASSWORD_TOO_LONG, "Expected")
            allure.attach("Msg: " + alter_password_long_new_password.get_msg(), "Actual:")
            assert constants.ERR_MSG_NEW_PASSWORD_TOO_LONG in alter_password_long_new_password.get_msg()
