...
class TestAlterPasswordWithoutUsername:
    ...
    def test_alter_password_without_username(self):
        ...
        with allure.step("Checking msg"):
            allure.attach("Msg: " + constants.ERR_MSG_ALTER_PSW_WITHOUT_USERNAME, "Expected")
            allure.attach("Msg: " + alter_password_without_username.get_msg(), "Actual:")
            assert alter_password_without_username.get_msg() == constants.ERR_MSG_ALTER_PSW_WITHOUT_USERNAME
