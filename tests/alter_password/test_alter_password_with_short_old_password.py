...
class TestAlterPasswordWithShortOldPassword:
    ...
    def test_alter_password_with_short_old_password(self):
        ...
        with allure.step("Checking msg"):
            allure.attach("Msg contains: " + constants.ERR_MSG_OLD_PASSWORD_TOO_SHORT, "Expected")
            allure.attach("Msg: " + alter_password_with_short_old_password.get_msg(), "Actual:")
            assert constants.ERR_MSG_OLD_PASSWORD_TOO_SHORT in alter_password_with_short_old_password.get_msg()
