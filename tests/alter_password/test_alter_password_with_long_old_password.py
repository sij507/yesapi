...
class TestAlterPasswordWithLongOldPassword:
    ...
    def test_alter_password_with_long_old_password(self):
        ...
        with allure.step("Checking msg"):
            allure.attach("Msg: " + constants.ERR_MSG_ALTER_PSW_OLD_PASSWORD_TOO_LONG, "Expected")
            allure.attach("Msg: " + alter_password_long_old_password.get_msg(), "Actual:")
            assert alter_password_long_old_password.get_msg() == constants.ERR_MSG_ALTER_PSW_OLD_PASSWORD_TOO_LONG