...
class TestAlterPasswordWithoutNewPassword:
    ...
    def test_alter_password_without_old_password(self):
        ...
        with allure.step("Checking msg"):
            allure.attach("Msg: " + constants.ERR_MSG_ALTER_PSW_WITHOUT_NEW_PASSWORD, "Expected")
            allure.attach("Msg: " + alter_password_without_new_password.get_msg(), "Actual:")
            assert alter_password_without_new_password.get_msg() == constants.ERR_MSG_ALTER_PSW_WITHOUT_NEW_PASSWORD
